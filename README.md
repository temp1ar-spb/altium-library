...
* Скрипты
    ...
    * **eskd-tools** - Python-скрипты: приведение .SchLib к ЕСКД и сверка выводов УГО с посадочными местами (без Altium)
